  ...
  <div class="row text-center">
    <div class="col-12 mb-3">
      <div class="row border rounded">
        ...
        <div class="col-3  p-2">Lot Count </div>
      </div>
    </div>
   ...
   <?php
      ...
      foreach ($catalogues as $key => $catalogue) {
        ...
        $viewItems= "<span class='float-right'><a href='/admin/catalogue/item/list?id={$catalogue['id']}' class=' p-1'><i class='fas fa-info-circle'></i></a></span>" ;
        ...
        <div class='col-3  p-2'>
        <span>{$catalogue['lotCount']} {$viewItems}</span>
